...
<gameSystem xmlns="http://www.battlescribe.net/schema/gameSystemSchema" id="sys-352e-adc2-7639-d6a9" name="Warhammer 40,000 11th Edition" revision="90" battleScribeVersion="2.03" type="gameSystem">
  <publications>
  ...
  <costTypes>
    ...
    <costType name="Detachment Points" id="f14f-8e07-c828-ae9b" defaultCostLimit="3"/>
  </costTypes>
  <profileTypes>
  ...
  <categoryEntries>
    ...
    <categoryEntry name="Reconanaissance" id="0bdd-4e3d-c778-8535" hidden="false"/>
    <categoryEntry name="Priority Assets" id="c21d-ad60-b624-17c4" hidden="false"/>
    <categoryEntry name="Take and hold" id="028c-c7b9-af0e-3b02" hidden="false"/>
    <categoryEntry name="Purge the foe" id="faf8-05e3-1e7d-15e7" hidden="false"/>
    <categoryEntry name="Disruption" id="0d77-9f29-f193-42de" hidden="false"/>
  </categoryEntries>
  <forceEntries>
...
If a model is in Hover mode, then until the end of the battle, its Move characteristic is changed to 20&quot;, it loses the **^^Aircraft^^** keyword and it loses all associated rules for being an **^^Aircraft^^** model. Models in Hover mode do not start the battle in Reserves, but you can choose to place them into Strategic Reserves following the normal rules if you wish.</description>
    ...
    <rule name="Disruption" id="566b-84fa-5384-3898" hidden="false"/>
    <rule name="Take and hold" id="1641-c290-aa7e-737d" hidden="false"/>
